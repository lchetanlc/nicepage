<?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-ff23">
    ...
    <div class="u-blog u-expanded-width u-repeater u-repeater-1"><?php
      ...
      <?php $postItemInvisible = !has_post_thumbnail() ? true : false; ?><div class="u-blog-post u-container-style u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--blog_post_header-->
          ...
          <?php
                            $post_image = theme_get_post_image(array('class' => 'u-blog-control u-expanded-width u-image u-image-default u-image-1', 'default' => '<?php echo get_template_directory_uri(); ?>/images/1.jpeg'));
          ...
          <a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-1"><?php _e(sprintf(__('Read More', 'webpage'))); ?></a><!--/blog_post_readmore-->
        </div>
      </div><!--/blog_post--><?php } ?><?php } ?><!--blog_post-->
      <!--/blog_post--><!--blog_post-->
      <!--/blog_post-->
    </div>
  </div>
